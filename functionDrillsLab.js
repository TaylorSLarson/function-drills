...
const compareNums = (num, num2) =>{
  ...
  function compareNumbers(eight, nine){
    eight = 8
    nine = 9
    if( eight < nine){
      console.log(nine)
...
// ASK WHY 'RETURN' NOT WORKING IN CONSOLE
 function addFirst(numOne, numTwo){
 console.log(numOne + numTwo)
}
 addFirst(5,6)
 addFirst(2, 8)
 addFirst(199.94, 67.83)              

function addSec(num1, num2){
  num1 = +num1
  num2 = +num2
  console.log (num1 + num2)
}

const sumOne = addSec(2, 4)

 function subOne(num3, num4){
 num3 = +num3
 num4 = +num4
 console.log (num3 - num4)
 }

 const sumTwo = subOne(12, 3)
...
// const movie = ('Pride and Predjudice')

 const bestMovie = movie => `${movie} is the best movie ever!`

// function bestMovieTwo(){
//   const movie = "Pride and Predjudice"
//   console.log(`${movie} is the best movie ever!`)
// }
...
const newContestants = theEliminator(contestants, loser)
...
// const totalFrogs = frogBought(100)


function chocoFrogs1(gold){
  return gold / 3
}

const totalFrogs1 = chocoFrogs1(100)
...
const totalFrogs2 = chocoFrogs2(100)
...
// const arrayAscending = checkArray(sampleArray)
